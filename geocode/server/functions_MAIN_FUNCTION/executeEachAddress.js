...
var executeEachAddress = function (mprn, address) {
    ...
    // add county
    if (dict_counties.hasOwnProperty(list_word[list_word.length - 1]) == false && /[A-Z]/.test(new_address)) {
        new_address= add_county(mprn,list_word);
        list_word = new_address.split(" ");
    }
